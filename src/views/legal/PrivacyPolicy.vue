<template>
  <div class="legal-privacy">
    ...
    <div content>
      ...
      <p>
        Thank you for choosing to be part of our community at Timo's Design
        ...
        regards to your personal information, please contact us using our
        <tc-link href="https://timos.design/legal">contact form</tc-link>.
      </p>
      <p>
        When you and more generally, use any of our services (the
        <b>"Services"</b>, which include the ), we appreciate that you are
      ...
      <p><b>In Short:</b> We collect information that you provide to us.</p>
      <p>
        ...
        the (such as by posting messages in our online forums or entering
      ...
      <p>
        ...
        section called
        <tc-link>"HOW DO WE HANDLE YOUR SOCIAL LOGINS"</tc-link> below.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          viewed by all users and may be publicly made available outside the in
      ...
      <p>
        Our offers you the ability to register and login using your third-party
      ...
      <p>
        ...
        <tc-link>"WILL YOUR INFORMATION BE SHARED WITH ANYONE?"</tc-link>
      ...
      <p>
        ...
        require us keeping your personal information for longer than two years.
      </p>
      <p>
      ...
      <p>
        ...
        collected from children under age 18, please contact us using out
        <tc-link href="https://timos.design/contact">contact form</tc-link>.
      </p>
      ...
      <p>
        ...
        <tc-link
          ...
          >http://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm</tc-link
        >.
      </p>
      <p>
        If you are resident in Switzerland, the contact details for the data
        protection authorities are available here:
        <tc-link href="https://www.edoeb.admin.ch/edoeb/en/home.html"
          >https://www.edoeb.admin.ch/edoeb/en/home.html</tc-link
        >.
      </p>
      ...
      <p>
        <u><b>Opting out of email marketing:</b></u> You can unsubscribe from
      ...
      <p>
        ...
        <tc-link href="https://accounts.timos.design/settings">here</tc-link>.
