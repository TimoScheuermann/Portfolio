      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Timo Scheuermann | Portfolio.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Timo Scheuermann | Portfolio,
            accessible from
            <a
              href="https://portfolio.timos.design"
              rel="external nofollow noopener"
              target="_blank"
              >https://portfolio.timos.design</a
            >
          </p>
        </li>
        <li>
